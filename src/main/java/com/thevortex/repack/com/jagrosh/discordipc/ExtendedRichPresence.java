...
import com.thevortex.repack.org.json.JSONArray;
...
public class ExtendedRichPresence extends RichPresence {
    ...
    private final String buttonLabel = "Install on CurseForge";
    private final String buttonUrl = "https://www.curseforge.com/minecraft/modpacks/all-the-mods-gravitas2/install";
    private final int buttonStyle = 5;
    ...
    public JSONObject toJson() {
        ...
        if (button_label_1 != null && button_url_1 != null) {
            ...
            btn1.put("style", buttonStyle);
            btn1.put("label", button_label_1);
            btn1.put("url", button_url_1);
            btn1.put("type", componentType);
            buttonsObj.put(btn1);
        }
        if (!buttonsObj.toList().isEmpty()) {
            jsonObject.put("components", buttonsObj);
